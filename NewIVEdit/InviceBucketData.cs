...
public class InvoiceBucketData
{
	...
	public void SetUp()
	{
		if (App.MainView.CurrentCompanyProfile == null || App.MainView.CurrentCompanyProfile.data_bucket == null || App.MainView.CurrentCompanyProfile.data_bucket.Length == 0) return;
		BucketDataColumn.Clear();
		foreach (var bucketProf in App.MainView.CurrentCompanyProfile.data_bucket)
		{
